                      ...
                      <td>
                        <div class="btn-group dropdown mt-2 mr-1">
                          ...
                          <ul class="dropdown-menu">
                            ...
                            <li>
                              <router-link :to="{name: 'ClientEdit', params: { id: client.id },}" class="dropdown-item"> <i class="fas fa-edit"></i> Edit </router-link>
                            </li>
                            <li>
                              <a href="#" @click="clientDelete(client.id)"  class="dropdown-item"> <i class="fas fa-trash"></i> Delete</a>
                            </li>
                          </ul>
                        </div>
                      </td>
