...
<p>
  ...
  <ul class="pagination" v-if="pagination.count">
    ...
    <li :class="{ disabled: !pagination.previous }" class="page-item">
      <a class="page-link" href="#!" v-on:click="setPage(pagination.previous)"><i class="fa fa-angle-left"> </i> Previous</a>
    </li>

    <li :class="{ disabled: !pagination.next }" class="page-item">
      <a class="page-link" href="#!" v-on:click="setPage(pagination.next)"> Next  <i class="fa fa-angle-right"> </i></a>
    </li>
  </ul>
